<script lang="ts">
    ...
    const errorMessage = $derived((actionData as { error?: string } | undefined)?.error);
                ...
                {#if success}
                    <div class="text-center py-4">
                        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-4">
                            <span class="material-icons-round text-green-600 dark:text-green-400 text-3xl mb-2">mark_email_read</span>
                ...
                {:else if !data.emailConfigured}
                    <div class="text-center py-4">
                        <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                            <span class="material-icons-round text-amber-600 dark:text-amber-400 text-3xl mb-2">warning</span>

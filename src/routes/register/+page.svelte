    ...
    <div class="w-full max-w-sm flex flex-col items-center">
        ...
        <div class="w-full rounded-xl border border-slate-200 bg-white p-7 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
            <div class="text-center mb-7">
                <h2 class="text-xl font-semibold tracking-tight text-[#111]">Create your workspace</h2>
                <p class="mt-1 text-sm text-slate-500">Get started with Slate — it's free</p>
            </div>
            ...
            {#if data.googleEnabled}
                ...
                >
                    ...
                    {#if googleLoading}Redirecting...{:else}Sign up with Google{/if}
                </button>
            ...
            <form method="POST" use:enhance id="register-form" class="space-y-4">
                <div class="space-y-1.5">
                    <Label for="name" class="text-sm font-medium text-[#111]">Your name</Label>
                    <Input
                        id="name"
                        name="name"
            ...
            <div class="mt-7 text-center border-t border-slate-100 pt-5">
                <span class="text-sm text-slate-500">
                    ...
                    <a href="/login" class="text-[#111] font-semibold hover:underline">Sign in</a>
                </span>
            </div>
        </div>
    </div>

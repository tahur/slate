    ...
    <div class="page-body">
        <div class="content-width-standard space-y-4">
            ...
            <div class="grid gap-3 sm:grid-cols-3">
                <div class="bg-surface-0 rounded-xl border border-border p-4">
            ...
            <!-- Search Bar -->
            <div class="rounded-xl border border-border bg-surface-0 p-3">
            ...
            {:else}
                <div class="overflow-hidden rounded-xl border border-border bg-surface-0 shadow-sm">
                        ...
                        {#each filteredVendors as vendor}
                            ...
                            >
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    {/if}
                                    <div
                                        class="mt-1 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-text-muted"
                                    >
                                        {#if vendor.phone}

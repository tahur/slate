...
<div class="flex flex-col h-[calc(100vh-3.5rem)] -mx-4 md:-mx-5 -my-4 md:-my-5">
    ...
    <div class="flex-1 overflow-y-auto px-6 py-8 pb-32 bg-surface-2/30">
        <div class="mx-auto max-w-4xl">
            <div
                class="bg-surface-1 border border-border rounded-lg shadow-sm p-8 space-y-8 min-h-[600px]"
            >
                <!-- Top Header -->
                <div class="flex justify-between items-start">
                    ...
                    <div class="text-right space-y-1">
                        ...
                        >
                            ...
                            {data.org?.state_code &&
                                `, ${data.org?.state_code}`}
                            {data.org?.pincode && ` - ${data.org?.pincode}`}
                        </div>
                    </div>
                </div>
                ...
                <div class="border rounded-md overflow-hidden">
                    <table class="w-full text-sm">
                        <thead class="bg-surface-2/50 border-b border-border">
                            <tr>
                                <th
                                    class="px-4 py-3 text-left font-medium text-text-secondary"
                                    >Description</th
                                >
                                <th
                                    class="px-4 py-3 text-right font-medium text-text-secondary"
                                    >Amount</th
                                >
                            </tr>
                        </thead>
